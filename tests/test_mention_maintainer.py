...
from orca_bot.tasks.mention_maintainer import mention_maintainer
...
def test_maintainer_mentioned(git_clone, mocker):
    github_mock = mocker.patch("orca_bot.tasks.mention_maintainer.github")
    ...
    modified_addons_mock = mocker.patch(
        "orca_bot.tasks.mention_maintainer.git_modified_addon_dirs"
    )
    modified_addons_mock.return_value = [addon_dir], False
    mocker.patch("orca_bot.tasks.mention_maintainer.check_call")
